...
public class SwaggerController 
{
		...
		{  
			return new Docket(DocumentationType.SWAGGER_2)
					...
					.select().apis(RequestHandlerSelectors.basePackage("com.hcl.controller"))  //whose methods do you want to add
					.build()
		...
		{  // used this object to store the meta data 
			return new ApiInfoBuilder().title("Course Management API")
					.description("Courses you can Add/Delete/Update/Modify")
